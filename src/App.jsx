...
/* ═══════════════════════════════════════════════════════════════
   ...
   Close the Loop – Packaging Division  v5.0
   All Tarrier data verified against Flexible Packaging Guide
...
/* ══════════════════════════════════════════════════════════════
   MATERIALS — OTR/WVTR verified against Flexible Packaging Guide
   OTR: cc/m²/day @23°C 0%RH | WVTR: g/m²/day @38°C 90%RH
...
/* ── BARRIER CHART REFS — verified from PDF Table p.4 ──────── */
const BREFS = [
...
/* ── LAMINATE BARRIERS — recalculated: harmonic mean of layers ─ */
const LB = {
...
/* ══════════════════════════════════════════════════════════════
   APPLICATION METADATA — shelf life, storage, requirements
   ══════════════════════════════════════════════════════════════ */
const APP_META = {
  frozen_food:    {shelf:"12\u201318 months",temp:"\u221240 to 0\u00B0C",  needs:"Puncture resistance, cold-chain seal integrity, moderate OTR Tarrier"},
  snacks:         {shelf:"6\u201312 months", temp:"Ambient",               needs:"Light Tarrier, OTR Tarrier, moisture Tarrier, N\u2082 flush retention"},
  confectionery:  {shelf:"6\u201312 months", temp:"Ambient",               needs:"Moisture Tarrier, light Tarrier, HFFS compatibility"},
  puffed_snacks:  {shelf:"3\u20136 months",  temp:"Ambient",               needs:"High OTR Tarrier for N\u2082 retention, VFFS compatibility, light Tarrier"},
  vacuum:         {shelf:"14\u201328 days chilled / 12+ months frozen",temp:"\u221218 to 5\u00B0C",needs:"High OTR Tarrier, puncture resistance, vacuum hold integrity"},
  liquids_hotfill:{shelf:"6\u201312 months", temp:"Fill up to 100\u00B0C", needs:"Heat resistance, Tarrier, seal integrity at high temperature"},
  retort:         {shelf:"18\u201336 months", temp:"121\u2013135\u00B0C autoclave",needs:"Absolute OTR + WVTR Tarrier, puncture resistance, retort-grade sealant"},
  coffee_tea:     {shelf:"12\u201324 months", temp:"Ambient",              needs:"High OTR Tarrier, aroma retention, light Tarrier, valve compatibility"},
  pet_food:       {shelf:"12\u201324 months", temp:"Ambient",              needs:"High OTR Tarrier, puncture resistance, fat/oil migration resistance"},
  powder:         {shelf:"12\u201324 months", temp:"Ambient",              needs:"High moisture Tarrier (hygroscopic), OTR Tarrier, seal integrity"},
  detergents:     {shelf:"24+ months",       temp:"Ambient",               needs:"Chemical resistance, high puncture resistance, opacity"},
  cosmetics:      {shelf:"12\u201336 months", temp:"Ambient",              needs:"Light Tarrier, moisture Tarrier, premium aesthetic, Trand shelf appeal"},
  lidding:        {shelf:"Application dependent",temp:"Varies",            needs:"Controlled peel force (4\u20138 N/15mm), Tarrier matching tray material"},
};

/* ══════════════════════════════════════════════════════════════
   DECISION RULES v5.0 — PDF-verified structures
...
const RULES = [
  ...
  {id:"retort_std",app:["retort"],sMin:1,sMax:3,
    c:{s:"PET / NY / AL / RCPP",p:"PET/NY/AL/RCPP",l:[
      ...
      {m:"AL_FOIL",r:"Tarrier",f:"Absolute O\u2082 + moisture Tarrier",t:"7\u20139\u00B5m"},
    ...
    u:{s:"Mono-PP / EVOH / RCPP",p:"PE/EVOH/PE",l:[
      ...
      {m:"EVOH",r:"Tarrier",f:"OTR Tarrier (<5% by weight)",t:"5\u00B5m"},
      {m:"RCPP",r:"sealant",f:"Retort sealant",t:"70\u2013100\u00B5m"}],
      n:"Emerging mono-PP retort. Post-retort EVOH Tarrier recovery must be validated."},
    why_c:"Aluminium foil provides zero-permeation Tarrier essential for 18\u201336 month ambient shelf life. Nylon delivers puncture and thermoforming resistance required to survive retort processing at 121\u2013135\u00B0C. RCPP sealant maintains seal integrity under autoclave pressure.",
    why_u:"Mono-PP structure with EVOH functional Tarrier (<5% by weight) enables recyclability while maintaining OTR Tarrier. EVOH is humidity-sensitive post-retort \u2014 Tarrier recovery time must be validated with accelerated shelf-life testing."},
  {id:"retort_sust",app:["retort"],sMin:4,sMax:5,
    c:{s:"PET / AL / RCPP",p:"PET/AL/RCPP",l:[
      {m:"BOPET",r:"surface",f:"Print / heat resistance",t:"12\u00B5m"},
      {m:"AL_FOIL",r:"Tarrier",f:"Absolute Tarrier",t:"7\u00B5m"},
      {m:"RCPP",r:"sealant",f:"Retort sealant",t:"70\u00B5m"}]},
    u:{s:"Mono-PP / EVOH / RCPP",p:"PE/EVOH/PE",l:[
      {m:"BOPP",r:"surface",f:"PP print carrier",t:"20\u00B5m"},
      {m:"EVOH",r:"Tarrier",f:"OTR Tarrier (<5%)",t:"3\u20135\u00B5m"},
      {m:"RCPP",r:"sealant",f:"Retort sealant",t:"70\u2013100\u00B5m"}],
      n:"Mono-PP retort is emerging technology. Post-retort EVOH performance must be validated."},
    why_c:"Simplified retort structure without nylon \u2014 AL foil still provides absolute Tarrier. Suitable where thermoforming is not required.",
  ...
  {id:"snacks_std",app:["snacks","confectionery"],sMin:1,sMax:3,
    c:{s:"OPP / VMPET / CPP",p:"OPP/VMPET/CPP",l:[
      ...
      {m:"VMPET",r:"Tarrier",f:"OTR + light Tarrier (OTR \u22642.5)",t:"12\u00B5m"},
    ...
    u:{s:"BOPP / VMOPP / BOPP-HS (mono-PP)",p:"BOPP/VMOPP/BOPP-HS",l:[
      ...
      {m:"VMOPP",r:"Tarrier",f:"Metallised OTR + moisture Tarrier",t:"20\u00B5m"},
      {m:"BOPP_HS",r:"sealant",f:"Heat-seal BOPP",t:"25\u00B5m"}],
      n:"Mono-PP recyclable. Validate bond strength on metallised surface."},
    why_c:"VMPET provides excellent OTR Tarrier (2.5 cc/m\u00B2/day), light Tarrier, and moisture Tarrier in one layer. BOPP surface gives high gloss print quality. Standard for snack packaging.",
    why_u:"All-PP structure enables recycling in PP stream. VMOPP (metallised BOPP) provides adequate Tarrier for snack shelf-life though lower OTR performance than VMPET."},
  {id:"snacks_sust",app:["snacks","confectionery"],sMin:4,sMax:5,
    c:{s:"OPP / VMPET / CPP",p:"OPP/VMPET/CPP",l:[
      {m:"BOPP",r:"surface",f:"Print / gloss",t:"20\u00B5m"},
      {m:"VMPET",r:"Tarrier",f:"OTR + light Tarrier",t:"12\u00B5m"},
      {m:"CPP",r:"sealant",f:"Sealant",t:"25\u201330\u00B5m"}]},
    u:{s:"BOPP / VMCPP (mono-PP, 2-layer)",p:"BOPP/VMCPP",l:[
      {m:"BOPP",r:"surface",f:"Print carrier",t:"20\u00B5m"},
      {m:"VMCPP",r:"Tarrier",f:"Metallised Tarrier + sealant",t:"25\u00B5m"}],
      n:"Mono-PP. VMCPP dual-function: Tarrier and sealant in one layer."},
    why_c:"Same proven conventional structure as standard priority.",
    why_u:"Simplified 2-layer mono-PP. VMCPP (metallised CPP) combines Tarrier and sealant functions, reducing layer count while maintaining recyclability."},
  ...
  {id:"puffed_std",app:["puffed_snacks"],sMin:1,sMax:3,
    ...
    u:{s:"BOPP / VMOPP / BOPP-HS (mono-PP)",p:"BOPP/VMOPP/BOPP-HS",l:[
      {m:"BOPP",r:"surface",f:"Print carrier",t:"20\u00B5m"},
      {m:"VMOPP",r:"Tarrier",f:"Metallised OTR Tarrier",t:"20\u00B5m"},
      {m:"BOPP_HS",r:"sealant",f:"PP sealant",t:"25\u00B5m"}],
      n:"Mono-PP recyclable. Validate N\u2082 retention with VMOPP Tarrier."},
    why_c:"N\u2082 flushed puffed snacks require reliable OTR Tarrier to maintain pillow pack inflation. VMPET provides OTR \u22642.5 cc/m\u00B2/day plus light Tarrier.",
  ...
  {id:"puffed_sust",app:["puffed_snacks"],sMin:4,sMax:5,
    ...
    u:{s:"BOPP / VMCPP (mono-PP, 2-layer)",p:"BOPP/VMCPP",l:[
      {m:"BOPP",r:"surface",f:"Print carrier",t:"20\u00B5m"},
      {m:"VMCPP",r:"Tarrier",f:"Metallised Tarrier + seal",t:"25\u00B5m"}],
      n:"Mono-PP. VMCPP dual Tarrier and sealant."},
    why_c:"Same conventional benchmark.",
    why_u:"Simplified 2-layer mono-PP. VMCPP acts as both Tarrier and sealant, minimising material complexity."},
  ...
  {id:"vacuum_std",app:["vacuum"],sMin:1,sMax:3,
    ...
    u:{s:"PE / EVOH / PE (mono-PE)",p:"PE/EVOH/PE",l:[
      ...
      {m:"EVOH",r:"Tarrier",f:"OTR Tarrier (<5% wt)",t:"3\u20135\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Sealant",t:"50\u00B5m"}],
    ...
    why_u:"Mono-PE with EVOH functional Tarrier achieves OTR ~0.5 cc/m\u00B2/day while enabling PE-stream recycling. Loss of nylon means reduced puncture resistance \u2014 must be validated."},
  ...
  {id:"hotfill_std",app:["liquids_hotfill"],sMin:1,sMax:3,
    ...
    u:{s:"MDO-PE / AlOx / PE",p:"MDO-PE/AlOx/PE",l:[
      {m:"MDO_PE",r:"surface",f:"Print web (PE-based)",t:"25\u00B5m"},
      {m:"PET_ALOX",r:"Tarrier",f:"AlOx transparent Tarrier",t:"12\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Sealant",t:"50\u00B5m"}],
      n:"AlOx replaces AL foil. Transparent Tarrier. Validate heat tolerance for hot-fill."},
    why_c:"PET provides heat resistance up to 220\u00B0C as the outer layer. AL foil gives zero-permeation Tarrier. CPP sealant handles hot-fill temperatures up to 100\u00B0C.",
    why_u:"AlOx-coated PET provides transparent high Tarrier (OTR ~0.5) without aluminium, paired with PE sealant. Heat tolerance of AlOx layer during filling must be validated."},
  {id:"hotfill_sust",app:["liquids_hotfill"],sMin:4,sMax:5,
    ...
    u:{s:"MDO-PE / SiOx / PE",p:"MDO-PE/SiOx/PE",l:[
      ...
      {m:"PET_SIOX",r:"Tarrier",f:"SiOx transparent Tarrier",t:"12\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Sealant",t:"50\u00B5m"}],
      n:"SiOx Tarrier is microwave-safe. Validate for hot-fill temperatures."},
  ...
  {id:"coffee_std",app:["coffee_tea"],sMin:1,sMax:3,
    c:{s:"PET / VMPET / PE",p:"PET/VMPET/PE",l:[
      ...
      {m:"VMPET",r:"Tarrier",f:"OTR + aroma + light Tarrier",t:"12\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Sealant",t:"50\u00B5m"}]},
    u:{s:"BOPP / VMOPP / BOPP-HS (mono-PP)",p:"BOPP/VMOPP/BOPP-HS",l:[
      {m:"BOPP",r:"surface",f:"Print carrier (PP)",t:"20\u00B5m"},
      {m:"VMOPP",r:"Tarrier",f:"Met OTR + aroma Tarrier",t:"20\u00B5m"},
      {m:"BOPP_HS",r:"sealant",f:"Heat-seal BOPP",t:"25\u00B5m"}],
      n:"Mono-PP recyclable. Metallised Tarrier critical for aroma retention. Validate shelf-life."},
    why_c:"Coffee requires high OTR Tarrier plus aroma retention and light protection. VMPET delivers all three functions. Laminate OTR ~2.4 cc/m\u00B2/day protects volatile aromatics.",
    why_u:"Mono-PP with metallised BOPP Tarrier. VMOPP provides OTR ~5 cc/m\u00B2/day with aroma and light Tarrier. Full PP recyclability. Verify extended shelf-life aroma retention vs VMPET benchmark."},
  {id:"coffee_sust",app:["coffee_tea"],sMin:4,sMax:5,
    c:{s:"PET / AL / PE",p:"PET/AL/PE",l:[
      {m:"BOPET",r:"surface",f:"Print carrier",t:"12\u00B5m"},
      {m:"AL_FOIL",r:"Tarrier",f:"Absolute aroma + OTR Tarrier",t:"7\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Sealant",t:"50\u00B5m"}]},
    u:{s:"BOPP / VMOPP / BOPP-HS (mono-PP)",p:"BOPP/VMOPP/BOPP-HS",l:[
      {m:"BOPP",r:"surface",f:"PP print carrier",t:"20\u00B5m"},
      {m:"VMOPP",r:"Tarrier",f:"Metallised aroma + OTR Tarrier",t:"20\u00B5m"},
      {m:"BOPP_HS",r:"sealant",f:"PP sealant",t:"25\u00B5m"}],
      n:"Mono-PP. Metallised PP provides best recyclable aroma Tarrier solution."},
    why_c:"Premium coffee uses AL foil for absolute aroma and OTR Tarrier. This is the conventional gold standard.",
  ...
  {id:"petfood_std",app:["pet_food"],sMin:1,sMax:3,
    c:{s:"PET / VMPET / PE",p:"PET/VMPET/PE",l:[
      ...
      {m:"VMPET",r:"Tarrier",f:"OTR + light + aroma Tarrier",t:"12\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Tough sealant (70\u00B5m)",t:"70\u00B5m"}]},
    u:{s:"MDO-PE / EVOH / PE (mono-PE)",p:"PE/EVOH/PE",l:[
      {m:"MDO_PE",r:"surface",f:"Print web",t:"25\u00B5m"},
      {m:"EVOH",r:"Tarrier",f:"OTR Tarrier (<5% wt)",t:"5\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Tough sealant",t:"70\u00B5m"}],
      n:"Mono-PE with EVOH. Validate EVOH for fat/oil migration resistance."},
    why_c:"Pet food requires high OTR Tarrier, light protection, and thick sealant for heavy product. VMPET provides multi-function Tarrier. Thick LLDPE handles puncture from kibble and bones.",
  ...
  {id:"petfood_sust",app:["pet_food"],sMin:4,sMax:5,
    ...
    why_c:"AL foil provides absolute Tarrier for extended shelf-life pet food.",
    why_u:"AlOx-coated PET provides transparent high Tarrier without aluminium. Recyclable profile. Must validate fat/oil migration resistance for pet food shelf-life."},

  /* ── POWDER ──────────────────────────────────────── */
  {id:"powder_std",app:["powder"],sMin:1,sMax:3,
    c:{s:"PET / VMPET / PE",p:"PET/VMPET/PE",l:[
      {m:"BOPET",r:"surface",f:"Print carrier",t:"12\u00B5m"},
      {m:"VMPET",r:"Tarrier",f:"Moisture + OTR Tarrier",t:"12\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Sealant (WVTR \u22641.0)",t:"50\u00B5m"}]},
    u:{s:"MDO-PE / SiOx / PE",p:"MDO-PE/SiOx/PE",l:[
      {m:"MDO_PE",r:"surface",f:"Print web",t:"25\u00B5m"},
      {m:"PET_SIOX",r:"Tarrier",f:"SiOx transparent moisture Tarrier",t:"12\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Sealant",t:"50\u00B5m"}],
      n:"SiOx excels at moisture Tarrier. Validate for hygroscopic powder products."},
    why_c:"Hygroscopic powders require excellent moisture Tarrier. VMPET delivers WVTR ~1.0 g/m\u00B2/day combined with PE sealant (WVTR ~1.0). Laminate WVTR ~0.47 g/m\u00B2/day.",
    why_u:"SiOx coating provides WVTR ~1.0 g/m\u00B2/day with transparency. Laminate WVTR ~0.33 g/m\u00B2/day \u2014 actually superior moisture Tarrier to conventional. Excellent for powder products."},
  {id:"powder_sust",app:["powder"],sMin:4,sMax:5,
    c:{s:"PET / AL / PE",p:"PET/AL/PE",l:[
      {m:"BOPET",r:"surface",f:"Print carrier",t:"12\u00B5m"},
      {m:"AL_FOIL",r:"Tarrier",f:"Absolute moisture Tarrier",t:"7\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Sealant",t:"50\u00B5m"}]},
    u:{s:"MDO-PE / AlOx / PE",p:"MDO-PE/AlOx/PE",l:[
      {m:"MDO_PE",r:"surface",f:"Print web (mono-PE)",t:"25\u00B5m"},
      {m:"PET_ALOX",r:"Tarrier",f:"AlOx high Tarrier",t:"12\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Sealant",t:"50\u00B5m"}],
      n:"AlOx replaces AL. Validate moisture protection for hygroscopic powders."},
    why_c:"AL foil provides zero-permeation moisture Tarrier for maximum protection.",
  ...
  {id:"detergents_std",app:["detergents"],sMin:1,sMax:3,
    c:{s:"PET / NY / LLDPE",p:"PET/NY/LLDPE",l:[
      ...
      {m:"BOPA",r:"core",f:"Puncture / chemical Tarrier",t:"15\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Heavy-duty sealant",t:"80\u2013100\u00B5m"}]},
    u:{s:"MDO-PE / LLDPE (mono-PE)",p:"MDO-PE/LLDPE",l:[
      {m:"MDO_PE",r:"surface",f:"Print web / stiffness",t:"30\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Heavy-duty sealant",t:"80\u2013100\u00B5m"}],
      n:"Full mono-PE recyclable. Low Tarrier requirement. Validate chemical compatibility."},
    ...
    why_u:"Detergents require minimal gas/moisture Tarrier. Mono-PE heavy-duty structure is sufficient. MDO-PE provides stiffness. Validate chemical resistance of PE print web with specific product."},
  {id:"detergents_sust",app:["detergents"],sMin:4,sMax:5,
    ...
    u:{s:"MDO-PE / LLDPE + PCR",p:"MDO-PE/LLDPE",l:[
      ...
      n:"Mono-PE with PCR sealant. Maximum recyclability for low-Tarrier application."},
    why_c:"Same conventional benchmark.",
    why_u:"At maximum sustainability, incorporate post-consumer recycled (PCR) PE in sealant layer. Detergent\u2019s low Tarrier requirement makes it ideal for PCR adoption."},

  /* ── COSMETICS ───────────────────────────────────── */
  {id:"cosmetics_std",app:["cosmetics"],sMin:1,sMax:3,
    c:{s:"OPP / VMPET / PE",p:"PET/VMPET/PE",l:[
      {m:"BOPP",r:"surface",f:"Print / gloss / premium",t:"20\u00B5m"},
      {m:"VMPET",r:"Tarrier",f:"Light + moisture Tarrier",t:"12\u00B5m"},
      {m:"LLDPE",r:"sealant",f:"Sealant",t:"50\u00B5m"}]},
    u:{s:"BOPP / VMOPP / BOPP-HS (mono-PP)",p:"BOPP/VMOPP/BOPP-HS",l:[
      {m:"BOPP",r:"surface",f:"Print carrier (PP)",t:"20\u00B5m"},
      {m:"VMOPP",r:"Tarrier",f:"Met light + Tarrier",t:"20\u00B5m"},
      {m:"BOPP_HS",r:"sealant",f:"PP sealant",t:"25\u00B5m"}],
      n:"Mono-PP recyclable. Metallised appearance maintained for premium aesthetic."},
    why_c:"Cosmetics packaging prioritises shelf appeal. BOPP gives high gloss print quality. VMPET provides light and moisture Tarrier to protect active ingredients. Metallised look conveys premium positioning.",
    why_u:"Mono-PP preserves the premium metallised aesthetic through VMOPP while enabling full recyclability. Matt or gloss BOPP surface for Trand differentiation."},
  {id:"cosmetics_sust",app:["cosmetics"],sMin:4,sMax:5,
    ...
    u:{s:"BOPP / VMOPP / BOPP-HS (mono-PP)",p:"BOPP/VMOPP/BOPP-HS",l:[
      ...
      {m:"VMOPP",r:"Tarrier",f:"Met premium finish + Tarrier",t:"20\u00B5m"},
      {m:"BOPP_HS",r:"sealant",f:"PP sealant",t:"25\u00B5m"}],
      n:"Full mono-PP. Premium appearance maintained."},
    why_c:"Same conventional benchmark.",
    why_u:"Mono-PP with premium metallised finish. Ideal for Trands with strong sustainability positioning. Full PP-stream recyclability."},
...
/* ── RISK NOTES ────────────────────────────────────────────── */
const RN = {
  BOPA:["Hygroscopic: store below 60% RH, condition Tefore lamination","Excellent flex crack resistance; OTR 40\u2013100 cc/m\u00B2/day but WVTR 20\u201340 g/m\u00B2/day"],
  ...
  EVOH:["OTR <1 dry but degrades to 10\u2013100 cc/m\u00B2/day above 75% RH","Must be sandwiched between PE or PP moisture Tarrier layers","Keep below 5\u20136% by weight for recyclability claims"],
  ...
  LLDPE:["Seal initiation: 105\u2013135\u00B0C, excellent hot tack for VFFS/HFFS","WVTR 0.5\u20132 g/m\u00B2/day \u2014 excellent moisture Tarrier"],
  PET_ALOX:["OTR 0.1\u20131, WVTR 0.5\u20133 \u2014 transparent ceramic Tarrier","Flex-sensitive: avoid sharp creasing during converting"],
  ...
  BOPP:["OTR 1200\u20132500, WVTR 3\u20138 g/m\u00B2/day","Excellent clarity and print surface, weak moisture Tarrier"],
...
const RC = {surface:B.blue, Tarrier:B.greenLight, core:B.coreFill, sealant:B.sealant};
const RL = {surface:"Surface / Print", Tarrier:"Barrier", core:"Core", sealant:"Sealant"};

/* ══════════════════════════════════════════════════════════════
   ENGINE v5.0 — ALL inputs connected, PDF-verified data
   ══════════════════════════════════════════════════════════════ */

function resolve(app, sust, Tarriers, mech, rest) {
  ...
  if (rest.includes("no_al")) {
    const sw = l => l.map(x => x.m === "AL_FOIL" ? {...x, m:"PET_ALOX", f:"AlOx Tarrier (replaces AL)"} : x);
  ...
  if (rest.includes("pcr")) warnings.push("PCR content required. Specify PCR-PE or PCR-PP sealant layers with supplier. Mass Talance or mechanical recycling certification needed.");
  ...
  if (Tarriers.includes("high_otr") && !hasBarrier(result.c.l, highBarrierMats))
    warnings.push("High OTR Tarrier selected but structure lacks dedicated Tarrier layer. Laminate OTR may exceed target.");
  if (Tarriers.includes("high_moisture") && !hasBarrier(result.c.l, ["AL_FOIL","VMPET","VMOPP","VMCPP","PET_ALOX","PET_SIOX"]))
    warnings.push("High WVTR Tarrier selected. Note: PE family has excellent inherent WVTR (0.5\u20132 g/m\u00B2/day).");
  if (Tarriers.includes("aroma") && !hasBarrier(result.c.l, ["AL_FOIL","VMPET","PET_ALOX","VMOPP"]))
    warnings.push("Aroma-critical application. Metallised or AL Tarrier layer recommended for volatile aroma retention.");
  if (Tarriers.includes("light") && !hasBarrier(result.c.l, ["AL_FOIL","VMPET","VMOPP","VMCPP"]))
    warnings.push("Light-sensitive product. Metallised or opaque Tarrier layer needed to prevent photo-oxidation.");
  ...
  if (mech.includes("n2")) warnings.push("N\u2082 flush: OTR Tarrier must maintain MAP atmosphere. Target laminate OTR <5 cc/m\u00B2/day for 6+ month shelf-life.");
  ...
  /* Rebuild Tarrier profile keys after any swaps */
...
/* ═══════════════════════════════════════════════════════════════
   COMPONENTS
   ═══════════════════════════════════════════════════════════════ */
const CS = {background:B.card,borderRadius:16,border:`1px solid ${B.light}`,boxShadow:"0 1px 3px rgba(0,0,0,0.04), 0 1px 2px rgba(0,0,0,0.02)"};

function Tog({active,onClick,children,isMobile}){
  return <button onClick={onClick} style={{border:`1.5px solid ${active?B.green:"transparent"}`,background:active?"rgba(200,214,54,0.12)":B.surface,
    color:active?B.charcoal:B.mid,padding:isMobile?"12px 18px":"10px 16px",borderRadius:10,fontSize:isMobile?15:14,fontWeight:active?600:500,cursor:"pointer",
    transition:"all 0.2s",fontFamily:"inherit",lineHeight:1.3,letterSpacing:0.1,minHeight:isMobile?44:"auto"}}>{children}</button>;
}

function Sec({letter,children}){
  return <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10,marginTop:22}}>
    <span style={{width:28,height:28,borderRadius:6,background:B.charcoal,color:B.white,fontSize:13,fontWeight:700,
      display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,letterSpacing:0.5}}>{letter}</span>
    <span style={{fontSize:13,fontWeight:700,letterSpacing:2,textTransform:"uppercase",color:B.charcoal}}>{children}</span>
  </div>;
}
...
function Stack({layers,title,type}){
  ...
  return <div style={{...CS,padding:20,borderTop:`3px solid ${ac}`}}>
    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:12}}>
      <span style={{fontSize:12,fontWeight:700,textTransform:"uppercase",letterSpacing:2,color:ac}}>{title}</span>
      <span style={{fontSize:10,fontWeight:600,padding:"4px 10px",borderRadius:20,background:abg,color:ac,letterSpacing:0.5}}>
        {layers.length} LAYER{layers.length!==1?"S":""}
      </span>
    </div>
    <div style={{fontSize:18,fontWeight:700,color:B.black,marginBottom:14,letterSpacing:-0.2}}>
    ...
    <div style={{borderRadius:8,overflow:"hidden",border:`1px solid ${B.light}`}}>
      {layers.map((layer,i)=>{
        ...
        return <div key={i} style={{display:"flex",minHeight:50,borderBottom:i<layers.length-1?`1px solid ${B.light}`:"none"}}>
          <div style={{width:6,flexShrink:0,background:rc}} />
          <div style={{flex:1,padding:"10px 18px",display:"flex",alignItems:"center",justifyContent:"space-between",background:`${rc}08`}}>
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              <span style={{fontSize:15,fontWeight:700,color:B.black,minWidth:60}}>{(MAT[layer.m]||{a:layer.m}).a}</span>
              <span style={{fontSize:12,color:B.mid,fontWeight:400}}>{layer.f}</span>
            </div>
            <span style={{fontSize:12,color:B.mid,fontWeight:500,flexShrink:0,background:B.surface,padding:"2px 8px",borderRadius:4}}>{layer.t}</span>
          </div>
        </div>;
      })}
    </div>
    <div style={{display:"flex",gap:16,marginTop:12}}>
      {Object.entries(RL).filter(([k])=>layers.some(l=>l.r===k)).map(([k,v])=>
        <div key={k} style={{display:"flex",alignItems:"center",gap:8}}>
          <div style={{width:12,height:12,borderRadius:3,background:RC[k]}} />
          <span style={{fontSize:11,color:B.mid,fontWeight:500}}>{v}</span>
        </div>)}
    </div>
  </div>;
}
...
function Radial({score,label,mono}){
  ...
  return <div style={{display:"flex",flexDirection:"column",alignItems:"center",padding:"12px 16px",borderRadius:12,background:bg}}>
    <svg width="110" height="110" viewBox="0 0 110 110">
      <circle cx="55" cy="55" r={r} fill="none" stroke={B.light} strokeWidth="5" />
      <circle cx="55" cy="55" r={r} fill="none" stroke={sc} strokeWidth="5" strokeDasharray={c} strokeDashoffset={off}
        strokeLinecap="round" transform="rotate(-90 55 55)" style={{transition:"stroke-dashoffset 0.8s cubic-bezier(0.4,0,0.2,1)"}} />
      <text x="55" y="51" textAnchor="middle" style={{fontSize:28,fontWeight:800}} fill={B.black}>{score}</text>
      <text x="55" y="69" textAnchor="middle" style={{fontSize:11,fontWeight:600}} fill={B.mid}>{label}</text>
    </svg>
    <div style={{marginTop:6,fontSize:10,fontWeight:700,padding:"4px 12px",borderRadius:20,
...
function Risks({layers,notes,warnings}){
  ...
  return <div style={{...CS,overflow:"hidden"}}>
    <button onClick={()=>setOpen(!open)} style={{width:"100%",display:"flex",alignItems:"center",justifyContent:"space-between",
      padding:"14px 20px",background:B.card,border:"none",cursor:"pointer",fontFamily:"inherit",
      borderBottom:open?`1px solid ${B.light}`:"none"}}>
      <div style={{display:"flex",alignItems:"center",gap:8}}>
        <div style={{width:6,height:6,borderRadius:3,background:B.coreFill}} />
        <span style={{fontSize:13,fontWeight:700,textTransform:"uppercase",letterSpacing:2,color:B.charcoal}}>Processing & Risk Notes</span>
        {warnings&&warnings.length>0&&<span style={{fontSize:10,fontWeight:700,padding:"2px 8px",borderRadius:10,background:"rgba(217,85,85,0.12)",color:B.red}}>
    ...
    {open&&<div style={{padding:"14px 20px"}}>
      {warnings&&warnings.length>0&&<div style={{marginBottom:12}}>
        {warnings.map((w,i)=><div key={i} style={{fontSize:12.5,color:"#8B4513",background:"rgba(217,85,85,0.06)",
      ...
      {notes&&<div style={{fontSize:12.5,color:B.charcoal,background:"rgba(200,214,54,0.08)",padding:"14px 18px",borderRadius:8,
      ...
      <div style={{display:"grid",gap:6}}>
        {ns.map((n,i)=><div key={i} style={{fontSize:12,color:B.mid,display:"flex",gap:10,lineHeight:1.5}}>
          <span style={{fontWeight:700,color:B.charcoal,flexShrink:0,width:56,fontSize:12}}>{n.mat}</span><span>{n.note}</span>
        </div>)}
      </div>
    </div>}
  </div>;
...
function WhySection({result, app, cR, sR, isMobile}){
  const meta = APP_META[app];
  if(!meta) return null;
  return <div style={{...CS,padding:24,marginTop:16}}>
    <div style={{fontSize:13,fontWeight:700,textTransform:"uppercase",letterSpacing:2,color:B.charcoal,marginBottom:14,
      display:"flex",alignItems:"center",gap:8}}>
      <div style={{width:6,height:6,borderRadius:3,background:B.green}} />
      Why This Recommendation
    </div>
    <div style={{fontSize:12.5,color:B.mid,marginBottom:14,lineHeight:1.6,padding:"8px 12px",borderRadius:8,background:B.surface}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:12}}>
      <div style={{padding:"14px 18px",borderRadius:8,borderLeft:`3px solid ${B.blue}`,background:"rgba(109,201,201,0.04)"}}>
        <div style={{fontSize:11,fontWeight:700,color:B.blue,textTransform:"uppercase",letterSpacing:1.5,marginBottom:6}}>Conventional Rationale</div>
        <div style={{fontSize:12.5,color:B.charcoal,lineHeight:1.7}}>{result.why_c}</div>
        <div style={{fontSize:11,color:B.mid,marginTop:8}}>Recyclability: {cR.l} ({cR.s}/100) {"\u2014"} {cR.mono?"Mono-material":"Multi-material"}</div>
      </div>
      <div style={{padding:"14px 18px",borderRadius:8,borderLeft:`3px solid ${B.green}`,background:"rgba(200,214,54,0.04)"}}>
        <div style={{fontSize:11,fontWeight:700,color:B.green,textTransform:"uppercase",letterSpacing:1.5,marginBottom:6}}>Sustainable Rationale</div>
        <div style={{fontSize:12.5,color:B.charcoal,lineHeight:1.7}}>{result.why_u}</div>
        <div style={{fontSize:11,color:B.mid,marginTop:8}}>Recyclability: {sR.l} ({sR.s}/100) {"\u2014"} {sR.mono?"Mono-material":"Multi-material"}</div>
      </div>
    </div>
  </div>;
}
...
export default function Dashboard(){
  ...
  const [Tarriers,setBarriers]=useState(["medium"]);
  ...
  const result=useMemo(()=>resolve(app,sust,Tarriers,mech,rest),[app,sust,Tarriers,mech,rest]);
  ...
  return <div style={{height:"100vh",display:"flex",flexDirection:"column",fontFamily:"'Inter',system-ui,-apple-system,sans-serif",background:B.surface,color:B.black,overflow:"hidden"}}>
    {/* HEADER */}
    <div style={{padding:"12px 24px",display:"flex",alignItems:"center",justifyContent:"space-between",background:B.black,flexShrink:0,borderBottom:`2px solid ${B.green}`}}>
      <div style={{display:"flex",alignItems:"center",gap:14}}>
        <div style={{width:42,height:42,borderRadius:8,background:B.green,display:"flex",alignItems:"center",justifyContent:"center"}}>
          <span style={{color:B.black,fontWeight:800,fontSize:14,letterSpacing:0.5}}>CTL</span>
        </div>
        <div>
          <div style={{color:B.white,fontSize:18,fontWeight:700,letterSpacing:0.3}}>Flexible Packaging Audit</div>
          <div style={{color:"#666",fontSize:11,letterSpacing:2.5,textTransform:"uppercase",marginTop:1}}>Close the Loop {"\u00B7"} Packaging Division</div>
        </div>
      </div>
      <div style={{display:"flex",alignItems:"center",gap:16}}>
        {!isMobile && <span style={{fontSize:11,color:"#555",letterSpacing:2,textTransform:"uppercase",fontWeight:600}}>Engineering Decision Tool</span>}
    ...
    <div style={{display:"flex",flexDirection:isMobile?"column":"row",flex:1,overflow:"hidden"}}>
      {/* LEFT: INPUT */}
      <div style={{width:isMobile?"100%":360,flexShrink:0,borderRight:isMobile?"none":`1px solid ${B.light}`,borderBottom:isMobile?`1px solid ${B.light}`:"none",overflowY:"auto",padding:"16px 22px 28px",background:B.white}}>
        <Sec letter="A">Application Type</Sec>
        <div style={{display:"flex",flexWrap:"wrap",gap:8}}>
          {APPS.map(a=><Tog key={a.id} active={app===a.id} onClick={()=>setApp(a.id)} isMobile={isMobile}>{a.i}{" "}{a.l}</Tog>)}
        </div>

        <Sec letter="B">Barrier Requirement</Sec>
        <div style={{display:"flex",flexWrap:"wrap",gap:8}}>
          {BOPT.map(o=><Tog key={o.id} active={Tarriers.includes(o.id)} onClick={()=>toggle(setBarriers)(o.id)} isMobile={isMobile}>{o.l}</Tog>)}
        </div>

        <Sec letter="C">Mechanical & Processing</Sec>
        <div style={{display:"flex",flexWrap:"wrap",gap:8}}>
          {MOPT.map(o=><Tog key={o.id} active={mech.includes(o.id)} onClick={()=>toggle(setMech)(o.id)} isMobile={isMobile}>{o.l}</Tog>)}
        </div>
        ...
        <div style={{padding:"4px 0"}}>
          ...
          <div style={{display:"flex",justifyContent:"space-between",marginTop:4}}>
            {["Performance","","Balanced","","Recyclability"].map((l,i)=>
              <span key={i} style={{fontSize:11,color:sust===i+1?B.charcoal:B.mid,fontWeight:sust===i+1?700:400,transition:"all 0.2s"}}>{l}</span>)}
          </div>
        </div>

        <Sec letter="E">Material Restrictions</Sec>
        <div style={{display:"flex",flexWrap:"wrap",gap:8}}>
          {ROPT.map(o=><Tog key={o.id} active={rest.includes(o.id)} onClick={()=>toggle(setRest)(o.id)} isMobile={isMobile}>{o.l}</Tog>)}
        </div>

        {/* Config Summary */}
        <div style={{marginTop:28,padding:18,borderRadius:14,background:B.surface,border:`1px solid ${B.light}`}}>
          <div style={{fontSize:11,textTransform:"uppercase",letterSpacing:2.5,color:B.mid,marginBottom:10,fontWeight:700}}>Active Configuration</div>
          <div style={{display:"grid",gap:6}}>
            ...
            <div style={{fontSize:12.5,display:"flex",justifyContent:"space-between"}}>
              ...
              <span style={{fontWeight:700,color:B.charcoal}}>{Tarriers.map(b=>BOPT.find(o=>o.id===b)?.l).join(", ")||"None"}</span>
            </div>
            {mech.length>0&&<div style={{fontSize:12.5,display:"flex",justifyContent:"space-between"}}>
            ...
            {rest.length>0&&<div style={{fontSize:12.5,display:"flex",justifyContent:"space-between"}}>
              <span style={{color:B.mid}}>Restrictions</span>
              <span style={{fontWeight:700,color:B.red}}>{rest.map(r=>ROPT.find(o=>o.id===r)?.l).join(", ")}</span>
            </div>}
            {result.warnings&&result.warnings.length>0&&<div style={{fontSize:12.5,display:"flex",justifyContent:"space-between",marginTop:4,padding:"4px 0",borderTop:`1px solid ${B.light}`}}>
      ...
      <div style={{flex:1,overflowY:"auto",padding:"22px 26px"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"5fr 3fr",gap:16,marginBottom:16}}>
          <div style={{...CS,padding:20}}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8}}>
              <div>
                <div style={{fontSize:13,fontWeight:700,textTransform:"uppercase",letterSpacing:2,color:B.charcoal}}>Barrier Trade-Off Chart</div>
                <div style={{fontSize:11,color:B.mid,marginTop:2}}>OTR vs WVTR (log scale). Lower = better Tarrier. Source: Flexible Packaging Guide.</div>
              </div>
            </div>
            ...
            <div style={{display:"flex",gap:20,justifyContent:"center",marginTop:6}}>
              <div style={{display:"flex",alignItems:"center",gap:5}}>
                ...
                <span style={{fontSize:11,color:B.mid,fontWeight:500}}>Conventional</span>
              </div>
              <div style={{display:"flex",alignItems:"center",gap:5}}>
                <div style={{width:12,height:12,transform:"rotate(45deg)",background:B.green,borderRadius:2}} />
                <span style={{fontSize:11,color:B.mid,fontWeight:500}}>Sustainable</span>
              </div>
              <div style={{display:"flex",alignItems:"center",gap:5}}>
                <div style={{width:9,height:9,borderRadius:5,background:"#ccc"}} />
                <span style={{fontSize:11,color:B.mid,fontWeight:500}}>Raw materials</span>
              </div>
            </div>
          </div>

          <div style={{...CS,padding:20,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:14}}>
            <div style={{fontSize:13,fontWeight:700,textTransform:"uppercase",letterSpacing:2,color:B.charcoal}}>Recyclability Score</div>
            <div style={{display:"flex",flexDirection:isMobile?"row":"row",gap:14,alignItems:"flex-start",flexWrap:"wrap",justifyContent:"center"}}>
              <div style={{textAlign:"center"}}>
                <div style={{fontSize:10,color:B.mid,textTransform:"uppercase",fontWeight:600,letterSpacing:1.5,marginBottom:6}}>Conv.</div>
                <Radial score={cR.s} label={cR.l} mono={cR.mono} />
              </div>
              <div style={{textAlign:"center"}}>
                <div style={{fontSize:10,color:B.green,textTransform:"uppercase",fontWeight:600,letterSpacing:1.5,marginBottom:6}}>Sust.</div>
        ...
        {/* WHY THIS RECOMMENDATION */}
        <WhySection result={result} app={app} cR={cR} sR={sR} isMobile={isMobile} />
        ...
        <div style={{marginTop:18,paddingTop:14,borderTop:`1px solid ${B.light}`,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <span style={{fontSize:10,color:B.mid,letterSpacing:2,textTransform:"uppercase",fontWeight:500}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:6}}>
            ...
            <span style={{fontSize:10,color:B.mid,fontWeight:600}}>v5.0</span>
          </div>
        </div>
      </div>
    </div>
